...
export default function TabelaNecropsias({ history }) {
...
async function newNecropsias ( data ) {
  ...
  const [state, setState] = React.useState({
    columns: [
      ...
      { title: 'Peso do animal necropsiado',
        field: 'peso',
        lookup: { 1: 'Até 100', 2: '+ de 100'},
      },
     
    ],
    data: [
      { n: '0', data: '21/09/2019', idetificacao: '0', nome: 'paciente 0', 
      especie: 'gato', exame: 'ultrassom' , peso:1},
