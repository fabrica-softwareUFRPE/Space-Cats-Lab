...
export default function TabelaCirurgiaSilvestre({history}) {
...
async function newCirurgiaSil( data ) {
...
<div className="sideBar">
      ...
      <div className="page-content" >
        <div className="table-wrapper" >
          <MaterialTable 
            title="Planilha de Procedimentos Cirúrgico de animais silvestres"
            options={{
              rowStyle: {
                height: 10,
                width:  1,
