...
export default function TabelaProcediDiagImagem({ history }) {
...
async function newProcedimentoImg ( data ) {
  ...
  const [state, setState] = React.useState({
    ...
    data: [
      ...
      especie: 'gato', exame: 'ultrassom' , estudo:1},
...
<div className="sideBar">
      ...
      <div className="page-content" >
        <div className="table-wrapper" >
          <MaterialTable 
            title="Planilha de Procedimentos de Diagnóstico por Imagem"
            options={{
              rowStyle: {
                height: 10,
                width:  1,
