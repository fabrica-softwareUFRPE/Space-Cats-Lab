...
export default function TabelaConsultaGra({ history }) {
...
async function newConsultaRetornoPeq ( data ) {
  ...
  const [state, setState] = React.useState({
    columns: [
      ...
      { title: 'Área do Atendimento', field: 'area'},
      { title: 'Função',
        field: 'funcao',
        lookup: { 1: 'Simples', 2: 'Complexo'},
      },
      { title: 'Casos Novos', field: 'casos'},
      { title: 'Retorno', field: 'retorno'},
...
<div className="sideBar">
      ...
      <div className="page-content" >
        <div className="table-wrapper" >
          <MaterialTable 
            title="Planilha de Consultar e Retornos de Animais de Grande Porte "
            options={{
              rowStyle: {
                height: 10,
                width:  1,
